$(function() {
    ...
    $.get(url).then(function(response){
        ...
        for (p,  p < dadosJson.length; p++;){
            ...
            if(tipo === 'VIDEO') { 
                conteudo += '<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-x1-4 col-xxl-4"><video style="width:100%; heigth:90%" controls><source src="'+feed.media_url+'"type="video/mp4" </video> </div>';
            }
            else if(tipo === 'IMAGE'){
                conteudo += '<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-x1-4 col-xxl-4"><img style="width:100%; heigth:90%" title="'+titulo+'" alt="'+titulo+'" src= "'+feed.media_url+'" onclick="window.open(\'' + feed.permalink + '\');"> </div>';
            }
